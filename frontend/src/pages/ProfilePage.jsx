  ...
  return (
    <div className="page-stack">
      ...
      <section className="learning-path-panel">
        <div className="section-heading"><div><p className="eyebrow">Review Schedule</p><h2>复测安排</h2></div><button className="ghost" disabled={pathLoading} onClick={loadPath}>{pathLoading ? "正在计算..." : "刷新计划"}</button></div>
